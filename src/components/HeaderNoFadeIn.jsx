...
export default function HeaderNoFadeIn() {
    ...
    return (
        <div style={{top: 0, left: 0}}>
            <div style={{width: "100%", height: "80px", background: "linear-gradient(180deg, rgba(0,0,0,1) 25%, rgba(255,255,255,0) 100%)", position: "fixed", zIndex: 10000, top: 0, left: 0}}>
                    ...
                    <div style={{cursor: "pointer", userSelect: "none", position: "absolute", marginLeft: windowWidth < 450 ? 70 : windowWidth < 800 ? 110 : 170, marginTop: -24, scale: windowWidth < 450 ? 0.75 : 1}}>
                        <a href="/details">    
                    ...
                    <div style={{cursor: "pointer", userSelect: "none", position: "absolute", marginLeft: windowWidth < 450 ? 115 : windowWidth < 800 ? 180 : 270, marginTop: -24, scale: windowWidth < 450 ? 0.75 : 1}}>
                        <a href="/tokenomics">    
                            <HoverScroll textValue={"TOKENOMICS"}/>
                        </a>
                    </div>

                    <div style={{cursor: "pointer", userSelect: "none", marginLeft: windowWidth < 450 ? 160 : windowWidth < 800 ? 270 : 390, marginTop: -24, postiion: "absolute", scale: windowWidth < 450 ? 0.75 : 1}}>
                        <HoverScroll textValue={"DOCUMENTATION"}/>
                    </div>

                    { windowWidth > 700 ? (
                        <>
                            <Button disableFocusRipple={true} disableRipple={true}  style={{position: "absolute", right: 32,  backgroundColor: "white", borderRadius: 2, height: "32px", width: "140px", color: "black", backgroundColor: "white", fontFamily: "Geist-Mono", fontSize: "11px"}}>
                                connect wallet
                            </Button>

                            <Button disableFocusRipple={true} disableRipple={true}  style={{position: "absolute", right: 180, color: "rgb(14, 14, 14)", backgroundColor: "rgba(255, 255, 255, 0.1)", color: "white", borderRadius: 2, height: "30px", width: "120px", fontFamily: "Geist-Mono", fontSize: "11px"}}>
                                join community
                            </Button>
                        </>
                        ) : 
